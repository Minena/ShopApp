...
import com.xx.Shopping.android.test.utils.MD5Utils;

public class LoginActivity extends AppCompatActivity{
    private TextView tv_main_title;//标题
    private TextView tv_register,tv_find_psw;//显示的注册，找回密码
    private Button btn_login,btn_back;//登录按钮,退出按钮
    ...
    protected void onCreate(Bundle savedInstanceState){
       ...
       //将顶部隐藏起来
        ...
        //客服文本框的编辑
        TextView tv1= (TextView) findViewById(R.id.kf);
       ...
       btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alertDialog.setButton(DialogInterface.BUTTON_NEGATIVE, "否", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(LoginActivity.this, "您已取消关闭按钮", Toast.LENGTH_SHORT).show();
                    }
                });
                alertDialog.show();
